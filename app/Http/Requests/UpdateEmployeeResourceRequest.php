...
class UpdateEmployeeResourceRequest extends FormRequest
{
    ...
    {
        $resourceId = $this->route('employee_resource')->id ?? $this->route('employee-resources');
        ...
        return [
            'resource_no' => [
                ...
                'string',
                'max:50',
                'unique:employee_resources,resource_no,' . $resourceId,
                'regex:/^[A-Z0-9\-\/]+$/'
            ],
