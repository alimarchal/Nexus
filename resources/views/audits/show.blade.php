<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-gray-200">
            <div class="border-b border-gray-200">
                <nav class="flex space-x-8 px-6 overflow-x-auto scrollbar-hide" aria-label="Tabs">
                    ...
                    <button
                        ...
                        data-tab="history">
                        History & Timeline @if($audit->statusHistories->count())({{ $audit->statusHistories->count()
                        }})@endif
                    </button>
                    <button
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap"
                        data-tab="documents">
                        Documents ({{ $audit->documents->count() }})
                    </button>
                    <button
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap"
                        data-tab="checklist">
                        Checklist @if($checklistItems->count())({{ $checklistItems->count() }})@endif
                    </button>
                    <button
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap"
                        data-tab="risks">
                    ...
                    <button
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap"
                        data-tab="team">
                        Team ({{ $audit->auditors->count() }})
                    </button>
                    <button
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap"
                        data-tab="schedules">
                        Schedules ({{ $audit->schedules->count() }})
                    </button>
                    <button
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap"
                        data-tab="notifications">
                        Notifications ({{ $audit->notifications->count() }})
                    </button>
                    <button
                        class="tab-button border-b-2 border-transparent py-4 px-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap"
                        data-tab="tags">
            ...
            <button onclick="showTab('findings')" id="tab-findings"
                class="tab-button inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-300 hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-900/50 dark:hover:text-blue-300 border-b-2 border-transparent">
                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <button onclick="showTab('notifications')" id="tab-notifications"
                ...
                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M15 17h5l-5 5v-5zM11 21H7a2 2 0 01-2-2V7a2 2 0 012-2h4m0 16v-7a2 2 0 012-2h9l-4-4">
                    </path>
                </svg>
                Notifications
            ...
            <button onclick="showTab('types')" id="tab-types"
                class="tab-button inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-300 hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-900/50 dark:hover:text-blue-300 border-b-2 border-transparent">
                <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- Update Audit Tab -->
    <div id="update-audit-tab" class="tab-content p-6">
        <div class="max-w-4xl mx-auto">
            <form method="POST" action="{{ route('audits.update', $audit) }}" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $audit->title) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="reference_no" id="reference_no"
                            value="{{ old('reference_no', $audit->reference_no) }}"
                            class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status" id="status"
                            class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">
                            @foreach(['planned','in_progress','reporting','issued','closed','cancelled'] as $status)
                            <option value="{{ $status }}" {{ old('status', $audit->status) === $status ? 'selected' : ''
                                }}>
                    ...
                    <div>
                        ...
                        <select name="priority" id="priority"
                            ...
                            <option value="{{ $r }}" {{ old('priority', $audit->priority) === $r ? 'selected' : '' }}>
                                {{ ucfirst($r) }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="date" name="planned_start_date" id="planned_start_date"
                            value="{{ old('planned_start_date', $audit->planned_start_date?->format('Y-m-d')) }}"
                            class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="planned_end_date" id="planned_end_date"
                            value="{{ old('planned_end_date', $audit->planned_end_date?->format('Y-m-d')) }}"
                            class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('description', $audit->description) }}</textarea>
                </div>

                <div class="flex justify-end">
                    <button type="submit"
                        class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow transition-colors duration-200">
                        Update Audit
                    </button>
                </div>
            </form>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                ...
                <form method="POST" action="{{ route('audits.documents.store', $audit) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium mb-2">Document File</label>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold">Documents ({{ $audit->documents->count() }})</h3>
                </div>
                <div class="p-6">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ ucfirst($doc->type) }} • {{
            ...
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No documents</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by uploading your first document.
                </p>
            </div>
            @endif
        </div>
    ...
    <div id="history-tab" class="tab-content p-6" style="display: none;">
        <div class="relative">
            <div
            ...
            <ul class="space-y-6">
                @forelse($audit->statusHistories as $history)
                <li class="relative pl-12 group">
                    <span class="absolute left-0 flex items-center justify-center w-8 h-8 rounded-full ring-4 ring-white dark:ring-gray-800 shadow-sm
                                    @switch($history->action_type)
                                        ...
                                        @case('Updated') bg-green-600 text-white @break
                                        @case('Priority Changed') bg-orange-500 text-white @break
                                        @case('Assigned') bg-green-600 text-white @break
                                        @case('Document Added') bg-blue-500 text-white @break
                                        @case('Finding Added') bg-purple-600 text-white @break
                                        @case('Risk Added') bg-red-600 text-white @break
                    ...
                    <div
                        class="bg-white dark:bg-gray-700 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-600 group-hover:shadow-md transition-all duration-200">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-sm text-gray-700 dark:text-gray-300 line-through">{{
                                    ...
                                    <div>
                                        ...
                                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{
                                            $history->new_value }}</span>
                                    </div>
                                    @endif
                                </div>
                                @endif
                                @if($history->description)
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">{{ $history->description }}</p>
                                @endif
                            </div>
                ...
                <li class="text-center py-10">
                    <div class="inline-flex flex-col items-center text-gray-500 dark:text-gray-400">
                        <svg class="w-12 h-12 mb-4 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <h3 class="text-sm font-medium">No history available</h3>
                        <p class="text-sm mt-1">Activity and changes will appear here as they occur.</p>
                    </div>
                </li>
                @endforelse
            </ul>
    ...
    <div id="documents-tab" class="tab-content p-6" style="display: none;">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                <h3 class="text-lg font-semibold mb-4">Create New Audit Type</h3>
                <form method="POST" action="{{ route('audit-types.store') }}">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold">Audit Types ({{ $auditTypes->count() }})</h3>
                </div>
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-{{ $type->color }}-100 text-{{ $type->color }}-800">
                                        {{ $type->name }}
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <p class="text-sm text-gray-900 dark:text-gray-100">{{ $type->description ?: '—' }}
                                    </p>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <form method="POST" action="{{ route('audit-types.destroy', $type) }}"
                                        class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" onclick="return confirm('Are you sure?')"
            ...
            @else
            <div class="text-center py-12">
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No audit types</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Start by creating your first audit type.</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <div id="tags-tab" class="tab-content p-6" style="display: none;">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                ...
                <form method="POST" action="{{ route('audit-tags.store') }}">
                    @csrf
            ...
            <!-- Assign Tags to Audit -->
            <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                <h3 class="text-lg font-semibold mb-4">Assign Tags to This Audit</h3>
                <form method="POST" action="{{ route('audit-tag-pivots.store', $audit) }}">
                    @csrf
                    <div class="flex gap-4">
                        <select name="tag_id" class="flex-1 border rounded-lg p-2">
                            <option value="">Select a tag...</option>
                            @foreach(\App\Models\AuditTag::all() as $tag)
            ...
            <!-- Existing Tags -->
            @php
            $auditTags = \App\Models\AuditTag::all();
            $assignedTags = $audit->tags ?? collect();
            @endphp

            @if($assignedTags->count())
            <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                <h3 class="text-lg font-semibold mb-4">Tags Assigned to This Audit</h3>
                <div class="flex flex-wrap gap-2">
                    @foreach($assignedTags as $tag)
                    <div
                        class="inline-flex items-center gap-2 px-3 py-1 bg-{{ $tag->color }}-100 text-{{ $tag->color }}-800 rounded-full text-sm">
                        {{ $tag->name }}
                        <form method="POST" action="{{ route('audit-tag-pivots.destroy', [$audit, $tag]) }}"
                            class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                                class="ml-1 text-{{ $tag->color }}-600 hover:text-{{ $tag->color }}-800">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold">All Available Tags ({{ $auditTags->count() }})</h3>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach($auditTags as $tag)
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            ...
                            <form method="POST" action="{{ route('audit-tags.destroy', $tag) }}" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" onclick="return confirm('Are you sure?')"
            ...
            @else
            <div class="text-center py-12">
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No tags available</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Start by creating your first tag.</p>
            </div>
            @endif
        </div>
    </div>
        ...
        <div id="content-update-audit" class="tab-content">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.update-basic-info', $audit) }}" class="space-y-6">
                        @csrf
                        @method('PATCH')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <div>
                                            <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">Start
                                                Date</label>
                                        ...
                                        <div>
                                            <label class="block text-sm text-gray-600 dark:text-gray-400 mb-1">End
                                                Date</label>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <form method="POST" action="{{ route('audits.update-status', $audit) }}" class="space-y-4">
                        @csrf
                        @method('PATCH')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                            ...
                            <div>
                                <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">New
                                    Status</label>
                        ...
                        <div>
                            <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Status
                                Change Notes</label>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.documents.store', $audit) }}"
                        ...
                        <div>
                            <label
                                class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Description</label>
                            <textarea name="description" rows="3" placeholder="Brief description of the documents..."
        ...
        <div id="content-checklist" class="tab-content hidden">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.checklist.add', $audit) }}" class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                        ...
                        <div>
                            <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Checklist
                                Item Title</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Max
                                    Score</label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="responses[{{ $ci->id }}][response_value]"
                                            value="{{ $resp->response_value ?? '' }}" placeholder="Enter response..."
                                            class="w-full text-base rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500" />
                                    </div>
                                    <div>
                                        <label
                                        ...
                                        <input type="number" step="0.01" name="responses[{{ $ci->id }}][score]"
                                            value="{{ $resp->score ?? '' }}" placeholder="0-{{ $ci->max_score ?? 100 }}"
                                            class="w-full text-base rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500" />
                                    </div>
                                    <div>
                                        <label
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.risks.add', $audit) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Risk
                                    Title</label>
                                <input type="text" name="title" required
        ...
        <div id="content-findings" class="tab-content hidden">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.findings.add', $audit) }}" class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                        ...
                        <div>
                            <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Finding
                                Title</label>
                            <input type="text" name="title" required
                                class="w-full text-base rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 shadow-sm focus:border-purple-500 focus:ring-purple-500"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Root
                                    Cause</label>
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <form method="POST" action="{{ route('audits.actions.add', [$audit, $finding]) }}"
                                    class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    @csrf
                                    <div>
                                        <input type="text" name="title" required placeholder="Action title..."
                                    ...
                                    <div class="md:col-span-2">
                                        <textarea name="description" rows="2" placeholder="Action description..."
        ...
        <div id="content-team" class="tab-content hidden">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.assign-auditors', $audit) }}" class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.scopes.add', $audit) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Scope
                                    Item</label>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            @if($auditor->is_primary)<span class="text-indigo-600 dark:text-indigo-400">
                                                •
                                                Primary</span>@endif
                                        </p>
                                    </div>
                                </div>
                                <form method="POST" action="{{ route('audits.auditors.delete', [$audit, $auditor]) }}"
                                    class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="return confirm('Remove this team member?')"
                            ...
                            <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                <div class="flex items-start justify-between">
                                    ...
                                    <form method="POST" action="{{ route('audits.scopes.delete', [$audit, $scope]) }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" onclick="return confirm('Remove this scope item?')"
                                            class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 text-sm">
                                            Remove
                                        </button>
                                    </form>
        ...
        <div id="content-schedule" class="tab-content hidden">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                    ...
                    <form method="POST" action="{{ route('audits.schedules.add', $audit) }}" class="space-y-6">
                        @csrf
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label
                        ...
                        <div>
                            <label class="block text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">Next
                                Run
                        ...
                        <div class="space-y-4">
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-2 gap-4 text-base">
                                    <div>
                                        <span class="font-semibold text-gray-700 dark:text-gray-300">Scheduled:</span>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                        ...
                        <div
                            ...
                            <form method="POST"
                                ...
                                class="inline">
                                @csrf
                                <button type="submit" class="text-blue-600 hover:text-blue-800 text-base font-semibold">
                                    Retry
                                </button>
                            </form>
                            @endif
    ...
    <!-- Missing Tab Containers -->
    <div style="display: none;">
        <!-- Checklist Tab -->
        <div id="checklist-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Checklist management functionality will be available soon.</p>
            </div>
        </div>
        ...
        <div id="risks-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Risk management functionality will be available soon.</p>
            </div>
        </div>
        ...
        <div id="findings-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Findings management functionality will be available soon.</p>
            </div>
        </div>

        <!-- Team Tab -->
        <div id="team-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Team management functionality will be available soon.</p>
            </div>
        </div>
        ...
        <div id="schedules-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Schedule management functionality will be available soon.</p>
            </div>
        </div>
        ...
        <div id="notifications-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Notifications management functionality will be available soon.</p>
            </div>
        </div>

        <!-- Types Tab -->
        <div id="types-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Audit types management functionality will be available soon.</p>
            </div>
        </div>
        ...
        <div id="metrics-tab" class="tab-content p-6" style="display: none;">
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                <p class="text-gray-600 text-sm">Metrics and analytics functionality will be available soon.</p>
            </div>
        </div>
    </div>
    </div>
    ...
    <script>
        // Enhanced Tab Configuration for Horizontal Layout
        const tabConfig = {
            'update-audit': {
                title: 'Update Audit',
            ...
            'schedule': {
                ...
                description: 'Manage audit schedules and recurring tasks',
                icon: 'calendar'
            },
            'notifications': {
                title: 'Notifications & Communication',
                description: 'Send and manage audit-related notifications',
                icon: 'notification'
            },
            'types': {
                title: 'Audit Types',
                description: 'Manage and configure different audit type categories',
                icon: 'tag'
            },
            'tags': {
                title: 'Tags Management',
                description: 'Create and assign tags for better audit organization',
                icon: 'tag'
            },
            'metrics': {
                title: 'Metrics & Analytics',
                description: 'View performance metrics and analytics dashboards',
                icon: 'chart'
            },
            'status': {
                title: 'Status History',
                description: 'Track audit status changes and historical progress',
                icon: 'history'
            }
        };

        // Enhanced Tab Management for Horizontal Layout
        function showTab(tabName) {
            ...
            document.querySelectorAll('.tab-button').forEach(button => {
                ...
                // Reset dark mode classes
                button.classList.remove('dark:text-blue-300', 'dark:bg-blue-900/50');
            ...
            if (selectedButton) {
                selectedButton.classList.add('active', 'border-blue-500', 'text-blue-700', 'bg-blue-50');
                selectedButton.classList.remove('border-transparent', 'text-gray-700', 'dark:text-gray-300');
                selectedButton.classList.add('dark:text-blue-300', 'dark:bg-blue-900/50');
            }

            // Store active tab in localStorage
            localStorage.setItem('activeAuditTab', tabName);

            // Scroll tab into view if needed (for mobile)
            if (selectedButton) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const lastActiveTab = localStorage.getItem('activeAuditTab') || 'update-audit';
        ...
        function handleTabResponsiveness() {
            ...
            if (tabsContainer) {
                ...
                // Add scroll behavior if tabs overflow
                if (totalTabsWidth > containerWidth) {
                    tabsContainer.classList.add('overflow-x-auto');
                    tabsContainer.style.scrollbarWidth = 'thin';
                }
            }
        }
        ...
        window.addEventListener('load', handleTabResponsiveness);
            'schedule': {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Clean tab initialization similar to complaints
            (function(){
                function initTabs(){
                    ...
                    // Show first tab (update-audit)
                    const firstTab = document.getElementById('update-audit-tab');
                    ...
                    const savedTab = localStorage.getItem('activeAuditTab');
                    if(savedTab) {
