<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-6">
                ...
                <!-- File Categories Module Card (Bank FMS) -->
                @can('view file categories')
                    <a href="{{ route('file-categories.index') }}"
                        class="transform hover:scale-110 transition duration-300 shadow-xl rounded-lg col-span-4 intro-y bg-white block">
                        <div class="p-5 flex justify-between">
                            <div>
                                <div class="text-3xl font-bold leading-8">{{ \App\Models\FileCategory::count() }}</div>
                                <div class="mt-1 text-base font-extrabold text-black">File Categories</div>
                            </div>
                            <img src="{{ url('icons-images/manual.png') }}" alt="File Categories" class="h-16 w-16">
                        </div>
                    </a>
                @endcan
    ...
    <a href="https://mc.imste.com/certificateCategory"
        class="transform hover:scale-110 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white block">
        <div class="p-5 flex justify-between">
            <div>
    ...
    <a href="https://mc.imste.com/instituteClass"
        class="transform hover:scale-110 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white block">
        <div class="p-5 flex justify-between">
            <div>
    ...
    <a href="https://mc.imste.com/account-category"
        class="transform hover:scale-110 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white block">
        <div class="p-5 flex justify-between">
            <div>
    ...
    <a href="https://mc.imste.com/transactions"
        class="transform hover:scale-110 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white block">
        <div class="p-5 flex justify-between">
            <div>
    ...
    <a href="https://mc.imste.com/bank-deposit"
        class="transform hover:scale-110 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white block">
        <div class="p-5 flex justify-between">
            <div>
