                    ...
                    <table
                        ...
                        <tbody>
                            @foreach ($dailyPositions as $region)
                                <tr>
                                    <td class="px-1 py-3 border border-black text-center">{{ $region->branches_count }}
                                    </td>
                                    <td class="px-1 py-3 border border-black text-center">{{ $region->name ?? 'N/A' }}
                                    </td>
