<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight inline-block">
            Edit File Category: {{ $fileCategory->category_name }}
        </h2>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="{{ route('file-categories.update', $fileCategory) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="category_code"
                            value="{{ old('category_code', $fileCategory->category_code) }}" maxlength="20"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="category_name"
                            value="{{ old('category_name', $fileCategory->category_name) }}" maxlength="100"
                            class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="is_active"
                            class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            <option value="1" {{ old('is_active', $fileCategory->is_active) == '1' ? 'selected' : '' }}>
                                Active</option>
                            <option value="0" {{ old('is_active', $fileCategory->is_active) == '0' ? 'selected' : '' }}>
                                Inactive</option>
                        </select>
