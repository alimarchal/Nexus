@php
    // Dashboard link only for users with a module on it (super admin always).
    $dashboardService = app(\App\Services\DashboardService::class);
    $showDashboard = $dashboardService->isVisibleTo(auth()->user());
    $homeUrl = $showDashboard || ! auth()->user() ? route('dashboard') : $dashboardService->landingUrl(auth()->user());
@endphp
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ $homeUrl }}">
                        <img src="{{ url('icons-images/BAJK logo.png') }}" alt="BAJK Logo" class="block h-9 w-auto">
