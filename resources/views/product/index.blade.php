...
<a href="{{ route('aksic-applications.index') }}"
                    ...
                    <div class="p-5 flex justify-between">
                        <div>
                            <div class="text-3xl font-bold leading-8">{{ \App\Models\AksicApplication::count() }}</div>
                            <div class="mt-1 text-base font-extrabold text-black">AKSIC Applications 2025</div>
                        </div>
                ...
                <a href={{ route('employee_resources.index') }}
                    ...
                    <div class="p-5 flex justify-between">
                        <div>
                            <div class="text-3xl font-bold leading-8">{{ \App\Models\EmployeeResource::count() }}</div>
