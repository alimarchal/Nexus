                ...
                <form method="GET" action="{{ route('stationery-transactions.index') }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select name="filter[printed_stationery_id]" id="stationery_item" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                <option value="">All Items</option>
                                @foreach($stationeries as $stationery)
                                    <option value="{{ $stationery->id }}" {{ request('filter.printed_stationery_id') == $stationery->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="filter[type]" id="transaction_type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                <option value="">All Types</option>
                                <option value="opening_balance" {{ request('filter.type') == 'opening_balance' ? 'selected' : '' }}>Opening Balance</option>
                                <option value="in" {{ request('filter.type') == 'in' ? 'selected' : '' }}>Stock In</option>
                                <option value="out" {{ request('filter.type') == 'out' ? 'selected' : '' }}>Stock Out</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="filter[stock_out_to]" id="stock_out_to" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                <option value="">All Destination Types</option>
                                <option value="Branch" {{ request('filter.stock_out_to') == 'Branch' ? 'selected' : '' }}>Branch</option>
                                <option value="Region" {{ request('filter.stock_out_to') == 'Region' ? 'selected' : '' }}>Region</option>
                                <option value="Division" {{ request('filter.stock_out_to') == 'Division' ? 'selected' : '' }}>Division</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="filter[branch_id]" id="branch_id" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <select name="filter[region_id]" id="region_id" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <select name="filter[division_id]" id="division_id" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <x-input type="number" name="filter[min_quantity]" id="min_quantity"
                                     value="{{ request('filter.min_quantity') }}" class="block mt-1 w-full" min="0" />
                        </div>

                        <div>
                            <x-label for="max_quantity" value="{{ __('Max Quantity') }}" />
                            <x-input type="number" name="filter[max_quantity]" id="max_quantity"
                                     value="{{ request('filter.max_quantity') }}" class="block mt-1 w-full" min="0" />
                        </div>
                    </div>
                        ...
                        @foreach ($transactions as $index => $transaction)
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-1 px-2 text-center">
                                    ...
                                    <div class="text-xs text-gray-500 font-normal">{{ $transaction->printedStationery->name ?? 'N/A' }}</div>
                                </td>
                                <td class="py-1 px-2 text-center">{{ $transaction->transaction_date->format('d-m-Y') }}</td>
                                <td class="py-1 px-2 text-center">
                                ...
                                <td class="py-1 px-2 text-center">{{ number_format($transaction->balance_after_transaction,2) }}</td>
                                <td class="py-1 px-2 text-center">
