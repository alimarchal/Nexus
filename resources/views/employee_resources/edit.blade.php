<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight inline-block">Edit Employee
            Resource: {{ $resource->resource_no }}</h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('employee_resources.update', $resource) }}"
                            ...
                            <div class="flex flex-col md:flex-row gap-4">
                                <div class="flex-1">
                                    ...
                                    <x-input id="resource_no" type="text" name="resource_no" class="mt-1 block w-full"
                                        :value="old('resource_no', $resource->resource_no)" required />
                                </div>
                                <div class="flex-1">
                                ...
                                <div class="flex-1">
                                    ...
                                    <select id="division_id" name="division_id"
                                        ...
                                        <option value="{{ $division->id }}" {{ old('division_id', $resource->
                                            division_id) == $division->id ? 'selected' : '' }}>{{ $division->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="flex-1">
                                    ...
                                    <select id="category_id" name="category_id"
                                        ...
                                        <option value="{{ $category->id }}" {{ old('category_id', $resource->
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Leave empty to keep the current
                                file</p>
                        </div>
                        <div class="flex items-center justify-end mt-4">
                            <x-button class="ml-4">Update Resource</x-button>
                        </div>
                    </form>
                </div>
            </div>
