<x-app-layout>
    ...
    <div class="py-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('complaints.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-8">
                        ...
                        <!-- Harassment fields (Hidden by default) -->
                        <div id="harassment-fields" style="display: none;">
                            <!-- 🔹 INVOLVED PARTIES SECTION (UPDATED) -->
                            <div class="mb-8">
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                   <div>

                                <label for="expected_resolution_date" class="block text-gray-700">Incident Date and Time
                                ...
                                @enderror
                                    ...
                                    <!-- Type of Harassment -->
                                    <div>
                                        <label class="block text-gray-700 mb-1">Type of Harassment</label>
                                        <select name="harassment_type"
                                            class="w-full border-gray-300 rounded-md shadow-sm">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 border-b pb-2">Involved Parties</h3>

                                <!-- Accused -->
                                <div class="mb-4">
                                    <h4 class="font-semibold text-gray-800 mb-2">Accused Person</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <input type="text" name="accused_id" placeholder="Employee ID (Optional)"
                                            class="border-gray-300 rounded-md w-full">
                                        <input type="text" name="accused_name" placeholder="Name"
                                            class="border-gray-300 rounded-md w-full" required>
                                        <input type="text" name="accused_designation" placeholder="Designation"
                                            class="border-gray-300 rounded-md w-full" required>
                                    </div>
                                </div>
                                ...
                                <!-- Witnesses -->
                                <div class="mb-4">
                                    <h4 class="font-semibold text-gray-800 mb-2 border-b border-gray-300 pb-2">Witnesses (Optional)</h4>

                                    <div id="witnesses-container">
                                        <div class="witness-entry grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                                            <h5 class="col-span-3 font-medium text-gray-600">Witness 1 (Optional)</h5>
                                            <input type="text" name="witnesses[0][id]" placeholder=" Employee ID (Optional)"
                                                class="border-gray-300 rounded-md w-full">
                                            <input type="text" name="witnesses[0][name]" placeholder="Name"
                                                class="border-gray-300 rounded-md w-full" required>
                                            <input type="text" name="witnesses[0][designation]"
                                                placeholder="Designation" class="border-gray-300 rounded-md w-full"
                                                required>
                                        </div>
                                    </div>

                                    <button type="button" id="add-witness"
        ...
        const harassmentFields = document.getElementById('harassment-fields');

        function toggleHarassmentFields() {
            let selectedText = categoryField.options[categoryField.selectedIndex]?.text || "";
            if (selectedText.trim().toLowerCase() === "harassment complaint") {
                harassmentFields.style.display = "block";
            } else {
                harassmentFields.style.display = "none";
            }
        }

        if (categoryField) {
            categoryField.addEventListener("change", toggleHarassmentFields);
            toggleHarassmentFields(); // page load par bhi check kare
        }
        ...
        document.getElementById('add-witness').addEventListener('click', function () {
            ...
            newWitness.classList.add('witness-entry', 'grid', 'grid-cols-1', 'md:grid-cols-3', 'gap-4', 'mb-2');

            newWitness.innerHTML = `
                <h5 class="col-span-3 font-medium text-gray-600">Witness  ${witnessIndex + 1}(Optional)</h5>
                <input type="text" name="witnesses (Optional)[${witnessIndex}][id]" placeholder="Employee ID (Optional)" class="border-gray-300 rounded-md w-full">
                <input type="text" name="witnesses (Optional)[${witnessIndex}][name]" placeholder="Name" class="border-gray-300 rounded-md w-full" required>
                <input type="text" name="witnesses (Optional)[${witnessIndex}][designation]" placeholder="Designation" class="border-gray-300 rounded-md w-full" required>
            `;
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <label for="complainant_account_number" class="block text-gray-700">Account
                                    ...
                                    Number <span class="text-gray-500 text-xs font-normal">(Optional)</span>:</label>
