{{-- Shared AKSIC UI styles (list, case, forms, budget, report). Plain CSS, ak- prefix. --}}
@once
<style>
    ...
    .ak-kpi-value-sm { font-size: 18px; line-height: 1.5; }
    ...
    /* Data table -- light header, horizontal rules only, sticky header,
       sticky applicant + actions columns, hover row, comfortable/compact
    ...
    .ak-dt-scroll.is-compact .ak-hide-compact { display: none; }  /* compact: drop secondary lines (father name, instalments) */
    ...
    /* Sticky columns keep the applicant and the row's actions in view while scrolling sideways */
